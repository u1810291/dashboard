...
import { StepStatus, VerificationStepTypes, getStepExtra } from 'models/Step.model';
import { CheckStepDetailsEntry } from 'apps/checks';
import React, { useMemo } from 'react';
import { useStyles } from './CustomWatchlistVerification.styles';
import { CustomWatchlistStepType } from '../../models/CustomWatchlist.model';
...
export function CustomWatchlistVerification({ data }: {
  ...
  return (
    <BoxBordered p={1} pt={2} pb={1} className={classes.bordered} width="400px">
