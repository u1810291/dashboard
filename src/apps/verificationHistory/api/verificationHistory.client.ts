...
export function saveVerificationAgentNote(identityId: string, eventId: string, params: Record<string, unknown>) {
  return http.patch(`/api/v1/dashboard/identities/${identityId}/event/${eventId}/agentNote`, params);
}
